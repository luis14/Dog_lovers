...
public class JRegistroMascotas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextField1.setText("Nombre de la mascota");

        jLabel4.setText("Chip:");

        jTextField2.setText("Chip de identificación");
        ...
        jTextField3.setText("Numero telefónico");

        jLabel7.setText("Email:");

        jTextField4.setText("dog_lovers@example.com");

        jLabel8.setText("Estado:");

        jRadioButton1.setText("Perdido");

        jRadioButton2.setText("Encontrado");

        jLabel9.setText("Lugar:");

        jTextField5.setText("Lugar donde fue perdido o encontrado");

        jLabel10.setText("Fecha:");

        jTextField6.setText("Fecha en la que fue perdido o encontrado");

        jLabel11.setText("Recompensa:");

        jTextField7.setText("Monto ");

        jRadioButton4.setText("Colones");
